/**
 * Step 5 — Data consent and submission.
 *
 * Displays the GDPR data processing consent text and two buttons:
 *  - "Sí, acepto" → submits the form via the API
 *  - "No acepto"  → navigates to the rejection screen
 *
 * This is the final step before the form data is sent to the backend.
 */
